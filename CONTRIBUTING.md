...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/graphviz-syntax-highlighting.git`).
...
Go to the [pull request page of GraphvizSyntaxHighlighting][PRs] and in the top
