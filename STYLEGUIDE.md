...
This is a general style guide that shall govern over all `GraphvizSyntaxHighlighting` repositories. The aim is
...
- You must always use relative imports for imports within the `GraphvizSyntaxHighlighting` library
